...
<head>
    ...
    <style>
        ...
        #withdrawGrid{height:calc(100% - 45px);}
...
<div class="contents_wrap" style="height: auto;">
    ...
    <div class="contents_header half_header">
        <div class="content_header_inner">
            ...
            <div class="form_object w283">
                <input type="hidden" id="WITHDRAW_ACCOUNT_ID">
                <input class="form_pop4_v2 fw50" type="text" data-pop="true" id="WITHDRAW_ACCOUNT_CODE" name="WITHDRAW_ACCOUNT_CODE">
                <button class="form_popup_btn2_v2" data-pop="true" data-id="WITHDRAW_ACCOUNT_CODE"></button>
                <input class="form_inp1_v2 fw50" type="text" id="WITHDRAW_ACCOUNT_NAME" name="WITHDRAW_ACCOUNT_NAME" readonly>
                <label class="label_inp0_v2" for="WITHDRAW_ACCOUNT_CODE">${fn:escapeXml(emax:word("출금계정"))}</label>
            </div>
            <div class="form_object w283">
    ...
    <div class="contents_header half_header" style="margin-top:10px;">
        <div class="content_header_inner" id="CALCULATE_DIV">
            ...
            <div class="form_object w10">
                <input class="form_inp0_v2" type="text" id="WITHDRAW_AMT" name="WITHDRAW_AMT" readonly data-reset="1">
                <label class="label_inp0_v2" for="WITHDRAW_AMT">${fn:escapeXml(emax:word("가지급금"))}</label>
            </div>
            <div class="form_object w10">
    ...
    <div class="contents_area half_h_contents">
        <div class="w100" style="height:300px;">
            <p class="ea_bt_form_title">${fn:escapeXml(emax:word("출금"))}</p>
            <div id="withdrawGrid"></div>
        </div>
        <div class="w100" style="height:300px;margin-top:16px;">
            <p class="ea_bt_form_title">${fn:escapeXml(emax:word("채무"))}</p>
            <div id="apGrid"></div>
        </div>
    </div>
</div>
