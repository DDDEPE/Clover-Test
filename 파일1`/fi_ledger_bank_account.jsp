	...
	<div class="contents_header half_header">
		<div class="content_header_inner">
			...
			<div class="form_object w283">
				<input type="hidden" id="TR_BI_BANK_ACCOUNT_ID" name="TR_BI_BANK_ACCOUNT_ID">
				<input class="form_pop4_v2 fw50" type="text" data-pop="true" id="ACCOUNT_NO" name="ACCOUNT_NO">
				<button class="form_popup_btn2_v2" data-pop="true" data-id="ACCOUNT_NO"></button>
	...
	<div class="contents_area half_h_contents">
		<div class="inner_tab_wrap2" id="inner_tab_wrap">
			<div class="grid_wrap">
				<ul class="inner_tabs">
                     <li class="inner_tab">
                         <a class="tab_link" href="#inner_tab0" title="">${fn:escapeXml(emax:word("계좌별 원장"))}</a>
                     </li>
                     <li class="inner_tab">
                         <a class="tab_link" href="#inner_tab1" title="" <%--style="pointer-events: none;"--%>>${fn:escapeXml(emax:word("계좌별 세부원장"))}</a>
                     </li>
                 </ul>
