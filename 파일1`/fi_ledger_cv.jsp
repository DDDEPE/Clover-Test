	...
	<div class="contents_header half_header">
		<div class="content_header_inner">
			...
			<div class="form_object w283">
				...
				<label class="label_inp0_v2" for="CV_NO">${fn:escapeXml(emax:word("거래처코드"))}</label>
			</div>
			<div class="form_object w283">
    ...
    <div class="contents_area half_h_contents">
        <div class="inner_tab_wrap2" id="inner_tab_wrap">
             <div class="grid_wrap">
                 <ul class="inner_tabs">
                     <li class="inner_tab">
                         <a class="tab_link" href="#inner_tab0" title="">${fn:escapeXml(emax:word("거래처별 원장"))}</a>
                     </li>
                     <li class="inner_tab">
                         <a class="tab_link" href="#inner_tab1" title="" <%--style="pointer-events: none;"--%>>${fn:escapeXml(emax:word("거래처별 세부원장"))}</a>
                     </li>
                 </ul>
