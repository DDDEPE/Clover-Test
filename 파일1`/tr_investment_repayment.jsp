		...
		<div class="contents_header">
			<div class="content_header_inner">
				...
				<div class="form_object w283 datepicker">
					...
					<label class="label_inp0_v2" for="">${fn:escapeXml(emax:word("상환일자"))}</label>
				</div>
				<div class="form_object w283 drop_box" id="TRANSFER_FLAG_DIV" style="position: relative;">
					<label class="label_inp0_v2" for="TRANSFER_FLAG_DIV">${fn:escapeXml(emax:word("원장등록여부"))}</label>
					<input type="hidden" id="TRANSFER_FLAG" name="TRANSFER_FLAG" value="" />
					<input type="text" name="TRANSFER_FLAG_DIV_TEXT" id="TRANSFER_FLAG_DIV_TEXT" value="" data-prev-val="" class="drop_box_inp" autocomplete="off" placeholder="" />
					<button type="button" class="drop_box_btn"></button>
					<ul class="drop_box_list"></ul>
				</div>
